...
void moon(int b,int n,int m)//In b,n,m will set the color3ub value
{
    int i;
...
void eidmoon(int b,int n,int m)//In b,n,m will set the color3ub value
{
    int i;
...
void buildingWindows(int x, int y, int z) {
    glLineWidth(8.0);
...
void drawCloud(int i,int y,int z){ //shape of cloud
	glPushMatrix();
...
void cloud(){ //first cloud  at the top
    glutPostRedisplay();
	if (cloudStatus == 1)
	{
		cloud_X += 0.03;
...
void cloud2(){ // second cloud at middle
    glutPostRedisplay();
	if (cloudStatus == 1)
	{
		cloud_X2 += 0.035;
...
void cloud3() //Third cloud at bottom
{
    glutPostRedisplay();
	if (cloudStatus == 1)
	{
...
void Night(int value){ //night view
